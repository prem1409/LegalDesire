        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() != null) {
                    ...
                    Intent i = new Intent(new Intent(Login.this, MainActivity.class));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                SharedPreferences.Editor editor = getSharedPreferences("store_name_and_email", MODE_PRIVATE).edit();
                editor.putString("person_name", personName);
                editor.putString("person_email", personEmail);
                editor.putString("person_photo", personPhoto.toString());
                editor.apply();
